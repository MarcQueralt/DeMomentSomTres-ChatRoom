...
function dmst_chatroom_registerScript() {
    ...
    wp_register_script('dmst-chatroom', plugins_url('js/demomentsomtres-chatRoom.js', __FILE__), array('opentok', 'dmst-chatroom-library'), '1.0.1', true);
    wp_register_script('dmst-chatroom-moderator', plugins_url('js/demomentsomtres-chatRoom-moderator.js', __FILE__), array('opentok', 'dmst-chatroom'), '1.0.1', true);
    wp_register_script('dmst-chatroom-shopper', plugins_url('js/demomentsomtres-chatRoom-shopper.js', __FILE__), array('opentok', 'dmst-chatroom'), '1.0.1', true);
}
...
function dmst_chatroom_printScript() {
    ...
    wp_print_scripts('dmst-chatroom');
    if ($dmst_chatroom_isModerator):
        wp_print_scripts('dmst-chatroom-moderator');
    else:
        wp_print_scripts('dmst-chatroom-shopper');
    endif;
}
